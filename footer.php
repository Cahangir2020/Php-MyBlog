...
<footer class="ftco-footer ftco-bg-dark ftco-section">
  ...
  <script src="<?=$template_url;?>js/jquery-migrate-3.0.1.min.js"></script>
  <script src="<?=$template_url;?>js/popper.min.js"></script>
  <script src="<?=$template_url;?>js/bootstrap.min.js"></script>
  <script src="<?=$template_url;?>js/jquery.easing.1.3.js"></script>
  <script src="<?=$template_url;?>js/jquery.waypoints.min.js"></script>
  <script src="<?=$template_url;?>js/jquery.stellar.min.js"></script>
  <script src="<?=$template_url;?>js/owl.carousel.min.js"></script>
  <script src="<?=$template_url;?>js/jquery.magnific-popup.min.js"></script>
  <script src="<?=$template_url;?>js/aos.js"></script>
  <script src="<?=$template_url;?>js/jquery.animateNumber.min.js"></script>
  <script src="<?=$template_url;?>js/scrollax.min.js"></script>
  <script src="<?=$template_url;?>https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?=$template_url;?>js/google-map.js"></script>
